...
export class ShoppingCart {
  ...
  public calculate(payment: string, id: string, address: string, billing?: string) {
    ...
    } else if (this.totalAmount < 1000) { this.ports = 10; }
    else { this.ports = 0; }
    ...
    if (
      ...
      (this.totalAmount > 1000 && this.country == 'France')
    ) {
...
export class Document {
  ...
  public print(doc: string) {
    if (doc) { Printer.print(doc); }
  }
  public email(doc: string, country: string) {
